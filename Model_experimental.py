...
if __name__=='__main__':
    ...
    training_set=tf.keras.utils.image_dataset_from_directory('train',labels='inferred',label_mode="categorical",image_size=(250, 250),subset="training",batch_size = 10)
    validation_set =tf.keras.utils.image_dataset_from_directory('test',labels='inferred',label_mode="categorical",image_size=(250, 250),subset="validation",batch_size = 10)
    model=model_Sq()
    ...
    model.save(f'Model_small.keras')
